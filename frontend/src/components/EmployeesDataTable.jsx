...
export default function EmployeesDataTable() {
    ...
    return (<Box sx={{width: '90%', height: "60%"}} className="table">
        ...
        <div className="tableBtns">
            <FormControlLabel
                ...
                className="denseBtn"
            />
            <div className="cancelDeleteBtn">
                <Button variant="contained" sx={{backgroundColor: "red", width: "200px", margin: "0 10px 0 5px"}}
                > Delete</Button>
                <Button variant="outlined"
                        sx={{border: "1px solid black", color: "black", width: "200px", margin: "0 10px 0 5px"}}
                > Cancel</Button>
            </div>
        </div>
    </Box>);
